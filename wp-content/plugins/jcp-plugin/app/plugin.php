...
class Plugin {
	...
	function __construct() {
		...
		// api
		// add_action('rest_api_init', array($this, 'register_example_rest_route'));
	}
...
/**
	...
	// function register_contact_rest_route() {
	// 	register_rest_route( 'wpinabox/v1', '/example', array(
	// 		'methods' => 'GET',
	// 		'callback' => array($this, 'handle_example_rest_route'),
	// 	) );
	// }

	// function handle_example_rest_route(\WP_REST_Request $request) {
	// 	return array('message' => 'Example rest route.');
	// }
